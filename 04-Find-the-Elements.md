...
![A cartoon. Two people are sketching on a whiteboard animatedly. One says 'a-ha!' while pointing to what they've drawn and the other, still sketching, says 'Yes! And then...'](intro_cartoon-7cdeaa7e5e113e22cde722646b3931f1f687ffdeefa3c0e0d20c85ef3f11e700.png)
...
![The word 'Invoice' is written with a horizontal line underneath.](invoice_breadboard_1-0642f3296128bbc742eeeafc5c95d587a806e022c63a6e002ed55f364e83c394.png)
...
!['Turn on Autopay' is written below the line.](invoice_breadboard_2-11885bd5693110b7fc4c13e28cf5eb7403471825f99268cd6eee50937050fbf5.png)
...
![An arrow points from 'Turn on Autopay' below 'Invoice' to a new place named 'Setup Autopay' with a line below it.](invoice_breadboard_3-a3c6b0db40bbfc8ab000453dae4506cc757da19796643905f7aae9377cfcdaec.png)
...
![The breadboard is further populated with affordances below Setup Autopay: CC fields, FI logo, and Submit. Submit has a connection arrow to a new place named Confirm. Below Confirm one affordance is named Thank You Message.](invoice_breadboard_4-d8497c1d4cbf3756ca16ce9ad4158c90ae1f9738511fbe0a77948076261d0ffb.png)
...
![The same breadboard is modified. Now below the Setup Autopay place there is a new affordance called Pay Balance Now with a question mark.](invoice_breadboard_5-b336abd287b752f0f38c15546d2d7a7981b9182733f1a0a9e8be4be4886a65be.png)
...
![The Invoicer's Customer List has one affordance: Customer Detail. Customer Detail points to Customer Page. Below that is an affordance to Disable Autopay.](invoice_breadboard_7-d5d53fc6b9bf9174d612d8da80f71469d8bfd014094fef9b617426fe8d83ab8b.png)
...
![A sketch drawn roughly with a fat-tipped marker. Squiggly lines suggest a to-do list with items. The first two items appear directly under the to-do list name. The rest of the items are separated by dividers. The top items with no divider above are labeled Loose and the divided ones below are labeled Grouped.](fat_marker_1-0584765a210e4d2c130096bbc8e862c363328afb9f227ecbc89421fe6a2544ef.png)

We could add items via some affordance within each group, including the “loose” group on top.

![A sketch showing an Add button below each set of items: the loose items and the items in each group.](fat_marker_2-570c445ea82290154b6a06b625ee31fbe780c62ff653ada1be939366bf39c103.png)
...
![Fat marker sketch of the Dot Grid as described in the previous chapter](calendar_dot_grid-7d1e375f646a32517d5d8d7ad444e45a09a54ac8f27e0abb059d71bd68650e55.png)
